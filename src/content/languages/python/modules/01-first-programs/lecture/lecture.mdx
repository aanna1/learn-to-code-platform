...
By the end of this lesson, you'll have written code that holds onto a handful of facts about a person and prints out a small summary. It's a tiny program. It's also more or less the shape of every program that ever does anything useful.
...
If anything in this lesson feels shaky — especially the difference between a variable name and a string — the exercises in this module are designed to drill exactly that. Module 2 assumes all of this is reflexive.
