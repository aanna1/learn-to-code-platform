from submission import identify_type
...
def test_identifies_boolean():
    ...
    assert identify_type(True) == "boolean", (
        ...
        "Remember: bool must be checked BEFORE int, since True and False are also integers in Python."
    )
...
def test_bool_not_confused_with_int():
    ...
    result_true = identify_type(True)
    result_false = identify_type(False)
    assert result_true == "boolean" and result_false == "boolean", (
